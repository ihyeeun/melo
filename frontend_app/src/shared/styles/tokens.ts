...
export const typography = StyleSheet.create<Record<TypoName, TextStyle>>({
  ...
  "typo-h2": createTypographyStyle(38, "semibold", "tight", 1.2),
  "typo-h3": createTypographyStyle(26, "semibold", "tight", 1.2),
  ...
  "typo-body2": createTypographyStyle(18, "semibold", "body", 1.2),
  "typo-body3": createTypographyStyle(16, "medium", "body", 1.45),
  "typo-body4": createTypographyStyle(14, "medium", "body", 1.45),
  "typo-label1": createTypographyStyle(18, "medium", "label", 1.4),
  "typo-label2": createTypographyStyle(16, "bold", "normal", 1.4),
  ...
  "typo-caption": createTypographyStyle(12, "medium", "normal", 1.3),
});
